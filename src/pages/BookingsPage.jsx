                        ...
                        <>
                            <div className="my-2 bg-gray-100 gap-4  w-full mx-auto flex rounded-lg" key={booking._id + '-' + index}>
                                ...
                                <div className="py-3 w-full" key={booking._id + index}>
                                    <h2 className="text-xl max-sm:text-sm" key={booking.place._id + index}>{booking.place.title}</h2>
                                    
                                    <div className=" border-t-2 border-gray-300 my-1 py-1">
                                        <div className="flex gap-2 items-center text-lg max-sm:text-xs">
                                        ...
                                        <div className="flex gap-x-8 max-sm:text-xs">  
                                            <span className="flex gap-x-1 items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 max-sm:size-5">
                                            ...
                                            <span className="flex gap-x-1 items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 max-sm:size-5 text-yellow-400">
                                            ...
                                            <span className="flex gap-x-1 items-center"> 
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 max-sm:size-5 text-green-400">
