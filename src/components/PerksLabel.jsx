            ...
            <div className="grid gap-2 grid-cols-3 md:grid-cols-3 lg:grid-cols-4">
                                {
                                    perksList.map((perk, index) =>
                                        <>
                                            <label htmlFor={perk} className="flex gap-4 mt-2 border p-2 rounded-lg cursor-pointer max-sm:text-sm max-sm:gap-2" key={perk} >
                                                ...
                                                <span className="flex gap-1" key={perk+index}>
                                                    {perk==='Wifi' && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 max-sm:size-5">
